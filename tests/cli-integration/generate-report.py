...
<div class="footer">
    ...
    <p>Failures are primarily expected for <code>symbols/defs/calls/callers</code> without SCIP index and <code>find_json</code> with duplicate <code>--output json</code> flag.</p>
