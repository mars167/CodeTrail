...
| T11 Precise SCIP integration | Pending | Requires ingesting external SCIP files and keeping parser fallback clearly labeled as fallback. |
...
4. CLI integration tests cover index-backed query behavior and completion generation.
